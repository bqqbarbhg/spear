...
/*
    ...
    void main()
    {
        vec3 param = texture(mainImage, v_uv).xyz * 1.0;
        vec3 param_1 = tonemap(param);
        vec3 _91 = linearToSrgb(param_1);
        o_color = vec4(_91, dot(_91, vec3(0.2989999949932098388671875, 0.58700001239776611328125, 0.114000000059604644775390625)));
    }
...
static const char Postprocess_fs_source_glsl330[988] = {
    ...
    0x75,0x76,0x29,0x2e,0x78,0x79,0x7a,0x20,0x2a,0x20,0x31,0x2e,0x30,0x3b,0x0a,0x20,
    ...
    0x3b,0x0a,0x20,0x20,0x20,0x20,0x76,0x65,0x63,0x33,0x20,0x5f,0x39,0x31,0x20,0x3d,
    ...
    0x6c,0x6f,0x72,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x5f,0x39,0x31,0x2c,0x20,
    0x64,0x6f,0x74,0x28,0x5f,0x39,0x31,0x2c,0x20,0x76,0x65,0x63,0x33,0x28,0x30,0x2e,
...
/*
    ...
    void main()
    {
        highp vec3 param = texture(mainImage, v_uv).xyz * 1.0;
        highp vec3 param_1 = tonemap(param);
        highp vec3 _91 = linearToSrgb(param_1);
        o_color = vec4(_91, dot(_91, vec3(0.2989999949932098388671875, 0.58700001239776611328125, 0.114000000059604644775390625)));
    }
...
static const char Postprocess_fs_source_glsl300es[1145] = {
    ...
    0x5f,0x75,0x76,0x29,0x2e,0x78,0x79,0x7a,0x20,0x2a,0x20,0x31,0x2e,0x30,0x3b,0x0a,
    ...
    0x68,0x70,0x20,0x76,0x65,0x63,0x33,0x20,0x5f,0x39,0x31,0x20,0x3d,0x20,0x6c,0x69,
    ...
    0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x5f,0x39,0x31,0x2c,0x20,0x64,0x6f,0x74,
    0x28,0x5f,0x39,0x31,0x2c,0x20,0x76,0x65,0x63,0x33,0x28,0x30,0x2e,0x32,0x39,0x38,
...
/*
    ...
    {
    #line 33 ""
        float3 param = mainImage.Sample(_mainImage_sampler, v_uv).xyz * 1.0f;
        float3 param_1 = tonemap(param);
        float3 _91 = linearToSrgb(param_1);
        o_color = float4(_91, dot(_91, float3(0.2989999949932098388671875f, 0.58700001239776611328125f, 0.114000000059604644775390625f)));
    }
...
*/
static const uint8_t Postprocess_fs_bytecode_hlsl5[1028] = {
    0x44,0x58,0x42,0x43,0xad,0xd7,0xdc,0x82,0xc5,0xe3,0x7f,0x45,0xd6,0xd8,0xe2,0x55,
    0x23,0xd3,0x7b,0xf7,0x01,0x00,0x00,0x00,0x04,0x04,0x00,0x00,0x05,0x00,0x00,0x00,
    0x34,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x34,0x01,0x00,0x00,0x68,0x01,0x00,0x00,
    0x68,0x03,0x00,0x00,0x52,0x44,0x45,0x46,0xc4,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    0x61,0x72,0x67,0x65,0x74,0x00,0xab,0xab,0x53,0x48,0x45,0x58,0xf8,0x01,0x00,0x00,
    0x50,0x00,0x00,0x00,0x7e,0x00,0x00,0x00,0x6a,0x08,0x00,0x01,0x5a,0x00,0x00,0x03,
    ...
    0x46,0x02,0x10,0x00,0x00,0x00,0x00,0x00,0x02,0x40,0x00,0x00,0x00,0x00,0x80,0x3f,
    ...
    0x46,0x02,0x10,0x00,0x01,0x00,0x00,0x00,0x2f,0x00,0x00,0x05,0x72,0x00,0x10,0x00,
    ...
    0x46,0x02,0x10,0x00,0x01,0x00,0x00,0x00,0x10,0x00,0x00,0x0a,0x82,0x20,0x10,0x00,
    ...
    0x0d,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x00,
...
/*
    ...
    fragment main0_out main0(main0_in in [[stage_in]], texture2d<float> mainImage [[texture(0)]], sampler mainImageSmplr [[sampler(0)]])
    {
        main0_out out = {};
    #line 33 ""
        float3 param = mainImage.sample(mainImageSmplr, in.v_uv).xyz * 1.0;
        float3 param_1 = tonemap(param);
        float3 _91 = linearToSrgb(param_1);
        out.o_color = float4(_91, dot(_91, float3(0.2989999949932098388671875, 0.58700001239776611328125, 0.114000000059604644775390625)));
        return out;
    }
...
static const char Postprocess_fs_source_metal_macos[1637] = {
    ...
    0x2e,0x78,0x79,0x7a,0x20,0x2a,0x20,0x31,0x2e,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,
    ...
    0x0a,0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x33,0x20,0x5f,0x39,0x31,0x20,
    0x3d,0x20,0x6c,0x69,0x6e,0x65,0x61,0x72,0x54,0x6f,0x53,0x72,0x67,0x62,0x28,0x70,
    ...
    0x34,0x28,0x5f,0x39,0x31,0x2c,0x20,0x64,0x6f,0x74,0x28,0x5f,0x39,0x31,0x2c,0x20,
