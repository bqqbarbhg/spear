...
/*
    ...
    void main()
    {
        ...
        float _89 = fract(gl_FragCoord.z * 256.0);
        if (!gl_FrontFacing)
        {
            albedo = vec3(0.0);
        }
        vec3 param = albedo;
        o_gbuffer0 = vec4(linearToSrgb(param), gl_FragCoord.z - (_89 * 0.00390625));
        o_gbuffer1 = vec4((normalize(v_normal) * 0.5) + vec3(0.5), _89);
    }
    
*/
static const char MapGBuffer_fs_source_glsl330[1116] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
    ...
    0x76,0x5f,0x75,0x76,0x2c,0x20,0x30,0x2e,0x30,0x29,0x2e,0x78,0x79,0x7a,0x20,0x2a,
    0x20,0x76,0x5f,0x74,0x69,0x6e,0x74,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x6c,0x6f,
    0x61,0x74,0x20,0x5f,0x38,0x39,0x20,0x3d,0x20,0x66,0x72,0x61,0x63,0x74,0x28,0x67,
    ...
    0x38,0x39,0x20,0x2a,0x20,0x30,0x2e,0x30,0x30,0x33,0x39,0x30,0x36,0x32,0x35,0x29,
    0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x6f,0x5f,0x67,0x62,0x75,0x66,0x66,0x65,0x72,
    0x31,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x28,0x6e,0x6f,0x72,0x6d,0x61,0x6c,
    0x69,0x7a,0x65,0x28,0x76,0x5f,0x6e,0x6f,0x72,0x6d,0x61,0x6c,0x29,0x20,0x2a,0x20,
    0x30,0x2e,0x35,0x29,0x20,0x2b,0x20,0x76,0x65,0x63,0x33,0x28,0x30,0x2e,0x35,0x29,
    0x2c,0x20,0x5f,0x38,0x39,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
...
/*
    ...
    void main()
    {
        highp vec3 albedo = textureLod(albedoAtlas, v_uv, 0.0).xyz * v_tint;
        highp float _89 = fract(gl_FragCoord.z * 256.0);
        if (!gl_FrontFacing)
        {
            albedo = vec3(0.0);
        }
...
*/
static const char MapGBuffer_fs_source_glsl300es[1279] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    ...
    0x5f,0x38,0x39,0x20,0x3d,0x20,0x66,0x72,0x61,0x63,0x74,0x28,0x67,0x6c,0x5f,0x46,
    ...
    0x20,0x28,0x5f,0x38,0x39,0x20,0x2a,0x20,0x30,0x2e,0x30,0x30,0x33,0x39,0x30,0x36,
    0x32,0x35,0x29,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x6f,0x5f,0x67,0x62,0x75,0x66,
    0x66,0x65,0x72,0x31,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x28,0x6e,0x6f,0x72,
    ...
    0x2e,0x35,0x29,0x2c,0x20,0x5f,0x38,0x39,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
...
/*
    ...
    {
    #line 31 ""
        float3 albedo = albedoAtlas.SampleLevel(_albedoAtlas_sampler, v_uv, 0.0f).xyz * v_tint;
    #line 32 ""
        float _89 = frac(gl_FragCoord.z * 256.0f);
    #line 36 ""
        if (!gl_FrontFacing)
        {
    #line 37 ""
    ...
    #line 40 ""
        float3 param = albedo;
        o_gbuffer0 = float4(linearToSrgb(param), gl_FragCoord.z - (_89 * 0.00390625f));
    #line 41 ""
        o_gbuffer1 = float4((normalize(v_normal) * 0.5f) + 0.5f.xxx, _89);
    }
...
*/
static const uint8_t MapGBuffer_fs_bytecode_hlsl5[1444] = {
    0x44,0x58,0x42,0x43,0x96,0x54,0x87,0xfa,0xe4,0x9d,0x4a,0x28,0x4a,0x78,0x06,0x33,
    0x0f,0x1e,0x5e,0x9d,0x01,0x00,0x00,0x00,0xa4,0x05,0x00,0x00,0x05,0x00,0x00,0x00,
    0x34,0x00,0x00,0x00,0x04,0x01,0x00,0x00,0xb0,0x01,0x00,0x00,0xfc,0x01,0x00,0x00,
    0x08,0x05,0x00,0x00,0x52,0x44,0x45,0x46,0xc8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    0x04,0x03,0x00,0x00,0x50,0x00,0x00,0x00,0xc1,0x00,0x00,0x00,0x6a,0x08,0x00,0x01,
    ...
    0x14,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0x00,0x00,0x00,
...
/*
    ...
    fragment main0_out main0(main0_in in [[stage_in]], texture2d<float> albedoAtlas [[texture(0)]], sampler albedoAtlasSmplr [[sampler(0)]], float4 gl_FragCoord [[position]], bool gl_FrontFacing [[front_facing]])
    {
        main0_out out = {};
    #line 31 ""
        float3 albedo = albedoAtlas.sample(albedoAtlasSmplr, in.v_uv, level(0.0)).xyz * in.v_tint;
    #line 32 ""
        float _89 = fract(gl_FragCoord.z * 256.0);
    #line 36 ""
        if (!gl_FrontFacing)
    ...
    #line 40 ""
        float3 param = albedo;
        out.o_gbuffer0 = float4(linearToSrgb(param), gl_FragCoord.z - (_89 * 0.00390625));
    #line 41 ""
        out.o_gbuffer1 = float4((normalize(in.v_normal) * 0.5) + float3(0.5), _89);
        return out;
    }
    
*/
static const char MapGBuffer_fs_source_metal_macos[1861] = {
    ...
    0x75,0x76,0x2c,0x20,0x6c,0x65,0x76,0x65,0x6c,0x28,0x30,0x2e,0x30,0x29,0x29,0x2e,
    ...
    0x20,0x66,0x6c,0x6f,0x61,0x74,0x20,0x5f,0x38,0x39,0x20,0x3d,0x20,0x66,0x72,0x61,
    ...
    0x65,0x20,0x33,0x36,0x20,0x22,0x22,0x0a,0x20,0x20,0x20,0x20,0x69,0x66,0x20,0x28,
    0x21,0x67,0x6c,0x5f,0x46,0x72,0x6f,0x6e,0x74,0x46,0x61,0x63,0x69,0x6e,0x67,0x29,
    0x0a,0x20,0x20,0x20,0x20,0x7b,0x0a,0x23,0x6c,0x69,0x6e,0x65,0x20,0x33,0x37,0x20,
    ...
    0x0a,0x20,0x20,0x20,0x20,0x7d,0x0a,0x23,0x6c,0x69,0x6e,0x65,0x20,0x34,0x30,0x20,
    ...
    0x28,0x5f,0x38,0x39,0x20,0x2a,0x20,0x30,0x2e,0x30,0x30,0x33,0x39,0x30,0x36,0x32,
    0x35,0x29,0x29,0x3b,0x0a,0x23,0x6c,0x69,0x6e,0x65,0x20,0x34,0x31,0x20,0x22,0x22,
    0x0a,0x20,0x20,0x20,0x20,0x6f,0x75,0x74,0x2e,0x6f,0x5f,0x67,0x62,0x75,0x66,0x66,
    0x65,0x72,0x31,0x20,0x3d,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x28,0x6e,0x6f,
    0x72,0x6d,0x61,0x6c,0x69,0x7a,0x65,0x28,0x69,0x6e,0x2e,0x76,0x5f,0x6e,0x6f,0x72,
    0x6d,0x61,0x6c,0x29,0x20,0x2a,0x20,0x30,0x2e,0x35,0x29,0x20,0x2b,0x20,0x66,0x6c,
    0x6f,0x61,0x74,0x33,0x28,0x30,0x2e,0x35,0x29,0x2c,0x20,0x5f,0x38,0x39,0x29,0x3b,
...
*/
static const char MapGBuffer_fs_source_metal_ios[1861] = {
    0x23,0x70,0x72,0x61,0x67,0x6d,0x61,0x20,0x63,0x6c,0x61,0x6e,0x67,0x20,0x64,0x69,
    0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x20,0x69,0x67,0x6e,0x6f,0x72,0x65,0x64,
    0x20,0x22,0x2d,0x57,0x6d,0x69,0x73,0x73,0x69,0x6e,0x67,0x2d,0x70,0x72,0x6f,0x74,
    0x6f,0x74,0x79,0x70,0x65,0x73,0x22,0x0a,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,
