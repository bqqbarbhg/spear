...
#define _SAPP_GL_FUNCS \
    ...
    _SAPP_XMACRO(glCopyTexSubImage2D,               void, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)) \
	_SAPP_XMACRO(glCopyTexSubImage3D,               void, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)) \
	_SAPP_XMACRO(glGenerateMipmap,                  void, (GLenum target)) \
	_SAPP_XMACRO(glCompressedTexSubImage2D,         void, (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void * data)) \
	_SAPP_XMACRO(glBindBufferRange,                 void, (GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size)) \
	_SAPP_XMACRO(glGetUniformBlockIndex,            GLuint, (GLuint program, const GLchar *uniformBlockName)) \
	_SAPP_XMACRO(glUniformBlockBinding,             void, (GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding)) \
